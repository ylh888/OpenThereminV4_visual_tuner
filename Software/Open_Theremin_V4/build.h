...
#define GATE_ON  128 //20 // That's the level which will drive the Gate high when volume increases from lower
#define GATE_OFF 128 //16 // That's the level which will drive the Gate low when volume decreases from higher
